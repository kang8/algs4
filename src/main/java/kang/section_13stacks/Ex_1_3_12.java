...
/**
 * Write an iterable {@link Stack} client that has a static method {@link Stack#copy(Stack)} that takes a
 * stack of strings as argument and returns a copy of the stack. Note: This ability is a prime
